              ...
              <tr>
                ...
                <td style="${td}width:34%;vertical-align:top;padding:0">
                  <div style="height:68pt;overflow:hidden;padding:4pt 7pt;line-height:1.15">
                    ...
                    <div style="margin-bottom:8pt">Signature: &nbsp; ${f.signatureImg ? signatureLine(f, 90) : '<span style="border-bottom:0.5pt solid #000;display:inline-block;width:80pt">&nbsp;</span>'}</div>
